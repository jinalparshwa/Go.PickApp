...
public class Filter_restaurantActivity extends AppCompatActivity implements filter_data {
    ...
    public static String result_cusine = "";
    public static String result_filter = "";
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_clear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                result_cusine = "";
                result_filter = "";
                Intent i = new Intent(Filter_restaurantActivity.this, Filter_restaurantActivity.class);
                startActivity(i);
                finish();
        ...
        rr_apply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Filter_restaurantActivity.this, Search_restaurantActivity.class);
                i.putExtra("Cusine", result_cusine);
                i.putExtra("Filter", result_filter);
                startActivity(i);
                finish();
    ...
    public void get_cuisine_one() {
        ...
        String url = Config.app_url + Config.searchonmapfiltertermsandroid;
        ...
        try {
            ...
            jobj_row.put("cuisinearray", result_cusine);
            jobj_row.put("filterarray", result_filter);


            JSONArray jarray_loginuser = new JSONArray();
            jarray_loginuser.put(jobj_row);

            jobj_loginuser.put("searchonmapfilterterms", jarray_loginuser);
    ...
    public void mydata(Model_Cusine_filter model) {
        ...
        for (int i = 0; i < name_arraylist.size(); i++) {
            ...
            result_cusine = builder.toString();
            Log.e("result", result_cusine);
        }
    ...
    public void mydata_filter(Model_filter model) {
        ...
        for (int i = 0; i < name_arraylist_filter.size(); i++) {
            ...
            builder.append(build);
            result_filter = builder.toString();
            Log.e("result_filter", result_filter);
        }
